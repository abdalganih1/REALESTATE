...
ealestate_db CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE 
ealestate_db;
...
ole ENUM('admin', 'buyer') NOT NULL
) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

-- Table: properties
CREATE TABLE IF NOT EXISTS properties (
    id INT AUTO_INCREMENT PRIMARY KEY,
    	ype VARCHAR(100) NOT NULL,
...
eceived_at DATETIME DEFAULT CURRENT_TIMESTAMP
) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
ole) VALUES
('admin', '\\\.z/o/a.k.F.u.1.A.n.g.l.e.C.r.y.p.t.e.d.P.a.s.s.w.o.r.d.H.e.r.e.F.o.r.A.d.m.i.n', 'admin'), -- replace with actual hash for 'adminpass'
('buyer', '\\\.y/o/b.k.F.u.1.B.n.g.l.e.C.r.y.p.t.e.d.P.a.s.s.w.o.r.d.H.e.r.e.F.o.r.B.u.y.e.r', 'buyer'); -- replace with actual hash for 'buyerpass'
...
INSERT IGNORE INTO properties (	ype, price, location, edrooms, athrooms, rea, loor, parking, description, image_url) VALUES
...
ame, email, subject, message) VALUES
